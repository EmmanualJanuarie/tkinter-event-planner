...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.geometry("370x440")  # dimensions of the form
    ...
    def show_event_form(self):
        ...
        # Input | Client Name
        self.entry_location = customtkinter.CTkEntry(self.form_frame_content, fg_color="white", placeholder_text="Client Name", corner_radius=20,
                                                      width=300, border_width=0, text_color='black')
        ...
        self.text_description.grid(row=7, column=1, pady=5, padx=10, )
